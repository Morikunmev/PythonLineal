...
indices_ordenados = sorted(range(len(rut)), key=lambda i: rut[i], reverse=True)
#Ordenada de forma ascendente
ascendente = sorted(range(len(rut)), key= lambda i: rut[i])

# Mostrar los valores ordenados por RUT en orden descendente
print("TERCERO: ")
